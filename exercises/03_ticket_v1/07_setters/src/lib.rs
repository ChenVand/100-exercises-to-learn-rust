...
impl Ticket {
    ...
    fn check_title_valid(title: &str) {
        if title.is_empty() {
    ...
    fn check_description_valid(description: &str) {
    ...
    fn check_status_valid(status: &str) {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Ticket::check_title_valid(&title);
        Ticket::check_description_valid(&description);
        Ticket::check_status_valid(&status);
