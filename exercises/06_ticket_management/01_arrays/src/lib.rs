...
impl WeekTemperatures {
    pub fn new() -> Self {
        WeekTemperatures{temp_vec: [None; 7]}
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        match day {
            Weekday::Monday => self.temp_vec[0],
            Weekday::Tuesday => self.temp_vec[1],
            Weekday::Wednesday => self.temp_vec[2],
            Weekday::Thursday => self.temp_vec[3],
            Weekday::Friday => self.temp_vec[4],
            Weekday::Saturday => self.temp_vec[5],
            Weekday::Sunday => self.temp_vec[6],
        }
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        match day {
            Weekday::Monday => self.temp_vec[0] = Some(temperature),
            Weekday::Tuesday => self.temp_vec[1] = Some(temperature),
            Weekday::Wednesday => self.temp_vec[2] = Some(temperature),
            Weekday::Thursday => self.temp_vec[3] = Some(temperature),
            Weekday::Friday => self.temp_vec[4] = Some(temperature),
            Weekday::Saturday => self.temp_vec[5] = Some(temperature),
            Weekday::Sunday => self.temp_vec[6] = Some(temperature),
        }
    }
}
